/*! elementor-pro - v3.0.0 - 23-08-2020 */
...
var _Reflect$construct = __webpack_require__(82);
...
var _Object$defineProperties = __webpack_require__(208);

var _Object$getOwnPropertyDescriptors = __webpack_require__(211);

var _Object$getOwnPropertyDescriptor = __webpack_require__(103);

var _Object$getOwnPropertySymbols = __webpack_require__(215);
...
var _objectSpread5 = _interopRequireDefault(__webpack_require__(128));
...
var _defineProperty2 = _interopRequireDefault(__webpack_require__(65));

var _baseContext = _interopRequireDefault(__webpack_require__(287));

var _commands = __webpack_require__(181);

var _component = _interopRequireDefault(__webpack_require__(238));
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(61)["__"], __webpack_require__(42)))
...
var arrayWithoutHoles = __webpack_require__(221);

var iterableToArray = __webpack_require__(222);

var unsupportedIterableToArray = __webpack_require__(195);

var nonIterableSpread = __webpack_require__(223);
...
$export($export.S + $export.F * !__webpack_require__(14), 'Object', { defineProperties: __webpack_require__(92) });
...
var _appUi = __webpack_require__(94);
...
function Modal(props) {
  return /*#__PURE__*/_react.default.createElement("section", {
    ...
    className: "eps-dialog__button eps-dialog__button-cancel",
    key: "cancel",
    ...
    className: "eps-dialog__button eps-dialog__button-submit",
    key: "apply",
    text: props.buttonApplyText,
...
var _modalsAndButtons = __webpack_require__(286);
...
function SiteTemplates(props) {
  var _React$useContext = _react.default.useContext(_templates.Context),
      ...
      gridColumns; // Make the templates object a memorize value, will re run again only if
  // templates has been changed, also sort the templates by `isActive`.


  templates = _react.default.useMemo(function () {
    return (0, _values.default)(templates).sort(function (a, b) {
      return a.isActive === b.isActive ? -1 : 1;
    });
  }, [templates]); // Start to capture screenshots.
  ...
  }, /*#__PURE__*/_react.default.createElement(_modalsAndButtons.PartActionsModals, null), /*#__PURE__*/_react.default.createElement(_appUi.CssGrid, {
    columns: gridColumns,
    spacing: 24,
    colMinWidth: 200
...
exports.PartActionsModals = PartActionsModals;
...
var _modalRename = _interopRequireDefault(__webpack_require__(321));

var _modalDelete = _interopRequireDefault(__webpack_require__(323));
...
function PartActionsModals() {
  var _React$useState = _react.default.useState(null),
      _React$useState2 = (0, _slicedToArray2.default)(_React$useState, 2),
      ModalRenameId = _React$useState2[0],
      setModalRenameId = _React$useState2[1];

  var _React$useState3 = _react.default.useState(null),
      _React$useState4 = (0, _slicedToArray2.default)(_React$useState3, 2),
      ModalDeleteId = _React$useState4[0],
      setModalDeleteId = _React$useState4[1];

  handlers.rename = setModalRenameId;
  handlers.delete = setModalDeleteId;
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_modalRename.default, {
    id: ModalRenameId,
    setModalId: setModalRenameId
  }), /*#__PURE__*/_react.default.createElement(_modalDelete.default, {
    id: ModalDeleteId,
    setModalId: setModalDeleteId
  }));
}
...
var _objectSpread2 = _interopRequireDefault(__webpack_require__(128));

var _promise = _interopRequireDefault(__webpack_require__(196));
    ...
    value: function checkConflicts(condition) {
      ...
      elementorCommon.ajax.addRequest('pro_theme_builder_conditions_check_conflicts', {
        ...
        data: {
          ...
          condition: (0, _objectSpread5.default)((0, _objectSpread5.default)({}, condition.clone().only(['type', 'name', 'sub', 'subId']).toJson()), {}, {
            _id: condition.id
          })
        }
      }).then(function (response) {
        _this4.updateConditionItemState(condition.id, {
          conflictError: response || null
        }, false);
      });
    }
    /**
...
var _router = __webpack_require__(550);
...
var _import = _interopRequireDefault(__webpack_require__(348));
...
var _router2 = _interopRequireDefault(__webpack_require__(353));
...
function SiteEditor() {
  ...
  return /*#__PURE__*/_react.default.createElement(_siteEditor.Layout, {
  ...
  }), /*#__PURE__*/_react.default.createElement(_appUi.NotFound, {
    default: true
  })))));
}
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(61)["__"]))
...
function Templates() {
  ...
  }, /*#__PURE__*/_react.default.createElement("h1", null, __('Your Site Global Parts', 'elementor-pro')), /*#__PURE__*/_react.default.createElement(_appUi.AddNewButton, {
...
var _siteTemplateBody = __webpack_require__(326);
...
var _modalsAndButtons = _interopRequireDefault(__webpack_require__(286));

var _indicatorBullet = __webpack_require__(324);
...
var SiteTemplateHeader = function SiteTemplateHeader(props) {
  var status = props.status && 'publish' !== props.status ? " (".concat(props.status, ")") : '',
    ...
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_appUi.Button, {
      ...
      size: "sm",
      url: props.editURL
    }), /*#__PURE__*/_react.default.createElement(_modalsAndButtons.default, props));
  },
...
exports.default = ModalRename;

var _react = _interopRequireDefault(__webpack_require__(10));

var _slicedToArray2 = _interopRequireDefault(__webpack_require__(193));

var _modal = _interopRequireDefault(__webpack_require__(237));
...
function ModalRename(props) {
  ...
  var closeModal = function closeModal(shouldUpdate) {
...
var SiteTemplateBody = function SiteTemplateBody(props) {
  var thumbnail = props.thumbnail || props.placeholderUrl,
      Overlay = function Overlay() {
    var previewButtonConfig = {
    ...
    }, /*#__PURE__*/_react.default.createElement(_appUi.Button, previewButtonConfig));
  },
      Thumbnail = function Thumbnail() {
    return /*#__PURE__*/_react.default.createElement(_appUi.CardImage, {
      alt: props.title,
      src: thumbnail
    }, !props.extended && /*#__PURE__*/_react.default.createElement(Overlay, null));
  };

  return /*#__PURE__*/_react.default.createElement(_appUi.CardBody, null, props.extended && props.previewUrl ? /*#__PURE__*/_react.default.createElement(_previewIframe.default, {
    src: props.previewUrl,
    templateType: props.type
  }) : /*#__PURE__*/_react.default.createElement(Thumbnail, null));
};
...
var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(197));
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(42), __webpack_require__(61)["__"]))
...
var Condition = /*#__PURE__*/function () {
  function Condition(args) {
    ...
    (0, _defineProperty2.default)(this, "conflictError", null);
    this.set(args);
  }
...
var _objectSpread3 = _interopRequireDefault(__webpack_require__(128));
...
var _typeof2 = _interopRequireDefault(__webpack_require__(84));
...
function ConditionsRows() {
  ...
  var rows = (0, _values.default)(conditions).map(function (condition) {
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: "row-controls ".concat(condition.conflictError && 'row-controls--error')
    ...
    })), condition.conflictError && /*#__PURE__*/_react.default.createElement("div", {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, rows, /*#__PURE__*/_react.default.createElement("div", {
...
var _select = _interopRequireDefault(__webpack_require__(239));
...
var _useDropZone2 = _interopRequireDefault(__webpack_require__(349));

var _importSuccessModal = _interopRequireDefault(__webpack_require__(350));

var _importErrorModal = _interopRequireDefault(__webpack_require__(351));
...
function Import() {
  var _React$useContext = _react.default.useContext(_templates.Context),
      ...
      action = _React$useContext.action,
      updateActionState = _React$useContext.updateActionState;

  var _React$useState = _react.default.useState(null),
      _React$useState2 = (0, _slicedToArray2.default)(_React$useState, 2),
      modalTemplate = _React$useState2[0],
      setModalTemplate = _React$useState2[1];

  var isUploading = _react.default.useMemo(function () {
    return action.current === _templates.TemplatesProvider.actions.IMPORT && action.loading;
  }, [action]);

  var hasError = _react.default.useMemo(function () {
    return action.current === _templates.TemplatesProvider.actions.IMPORT && action.error;
  }, [action]);
  ...
  var _useDropZone = (0, _useDropZone2.default)({
    onDrop: function onDrop(event) {
      upload(event.dataTransfer.files[0]);
    }
  }),
      inDropZone = _useDropZone.inDropZone,
      handleDragOver = _useDropZone.handleDragOver,
      handleDragLeave = _useDropZone.handleDragLeave,
      handleDragEnter = _useDropZone.handleDragEnter,
      handleDrop = _useDropZone.handleDrop;

  var savingIcon = isUploading ? 'eicon-spinner' : '';
  return /*#__PURE__*/_react.default.createElement("section", {
    className: "site-editor__import"
  }, modalTemplate && /*#__PURE__*/_react.default.createElement(_importSuccessModal.default, {
    template: modalTemplate
  }), hasError && /*#__PURE__*/_react.default.createElement(_importErrorModal.default, {
    error: action.error,
    ...
    className: "upload-box__inner ".concat(inDropZone && 'upload-box__inner--active'),
    onDragEnter: handleDragEnter,
    onDragLeave: handleDragLeave,
    onDragOver: handleDragOver,
    onDrop: handleDrop
  }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_appUi.Icon, {
    className: "eicon-library-upload upload-box__icon"
  }), /*#__PURE__*/_react.default.createElement("h1", {
    className: "upload-box__title"
  }, __('Import Template To Your Library', 'elementor-pro')), /*#__PURE__*/_react.default.createElement("p", {
    className: "upload-box__description"
  }, __('Drag & Drop your .JSON or .zip template file', 'elementor-pro')), /*#__PURE__*/_react.default.createElement("p", {
    className: "upload-box__or"
  }, __('or', 'elementor-pro')), /*#__PURE__*/_react.default.createElement("label", {
    htmlFor: "file"
  }, /*#__PURE__*/_react.default.createElement(_appUi.Button, {
    variant: "contained",
    color: "primary",
...
function useDropZone(_ref) {
  ...
  var _React$useState = React.useState(false),
      _React$useState2 = (0, _slicedToArray2.default)(_React$useState, 2),
      inDropZone = _React$useState2[0],
      setInDropZone = _React$useState2[1];

  var handleDragEnter = preventDefault(function (event) {
    setInDropZone(true);
  ...
  var handleDragLeave = preventDefault(function (event) {
    setInDropZone(false);
  ...
  var handleDragOver = preventDefault(function (event) {
    if (!inDropZone) {
      setInDropZone(true);
    }
  ...
  var handleDrop = preventDefault(function (event) {
    setInDropZone(false);
...
exports.default = ImportSuccessModal;
...
function ImportSuccessModal(props) {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    onApply: function onApply() {
      return location.href = props.template.url;
    },
    onCancel: function onCancel() {
      return location.href = props.template.editURL;
    }
  }, /*#__PURE__*/_react.default.createElement("p", {
    className: "success-modal__description"
...
exports.default = ImportErrorModal;
...
function ImportErrorModal(props) {
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    className: "error-modal__description"
  }, props.error)));
}
