...
class Product_Archive extends Archive {
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Global Products Archive?', 'elementor-pro' ),
			'content' => __( 'A global archive product template allows you to easily design the layout and style of your WooCommerce shop page or other product archive pages - those pages that show a list of products, which may be filtered by terms such as categories, tags, etc.', 'elementor-pro' ),
