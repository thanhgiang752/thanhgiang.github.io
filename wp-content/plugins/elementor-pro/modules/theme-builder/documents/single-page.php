...
class Single_Page extends Single_Base {
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Global Page?', 'elementor-pro' ),
			'content' => __( 'A global page template allows you to easily create the layout and style of pages, ensuring design consistency across all the pages of your site.', 'elementor-pro' ),
