...
class Footer extends Header_Footer_Base {
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Global Footer?', 'elementor-pro' ),
			'content' => __( 'The Global Footer allows you to easily design and edit custom WordPress footers without the limits of your theme’s footer design constraints', 'elementor-pro' ),
