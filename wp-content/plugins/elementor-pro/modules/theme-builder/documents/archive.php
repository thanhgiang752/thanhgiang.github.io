...
class Archive extends Archive_Single_Base {
	...
	protected static function get_site_editor_tooltip_data() {
		return [
			'title' => __( 'What is a Global Archive?', 'elementor-pro' ),
			'content' => __( 'A global archive template allows you to easily design the layout and style of archive pages - those pages that show a list of posts (e.g. a blog’s list of recent posts), which may be filtered by terms such as authors, categories, tags, search results, etc.', 'elementor-pro' ),
			...
			'video_url' => 'https://www.youtube.com/embed/7rDIS1Li4jM',
		];
	}
